...
\section{Cronograma}
 A tabela a seguir representa o cronograma de atividades para o TCC 1
 \begin{table}[H]
\centering
\caption{Cronograma TCC 1}
\begin{tabular}{|l|c|c|c|c|c|}
\hline
\textbf{Atividades}                      & \textbf{Março} & \textbf{Abril} & \textbf{Maio} & \textbf{Junho} & \textbf{Julho} \\ \hline
Definição do tema                        & X                &                 &                   &                   &                   \\ \hline
Pesquisa bibliográfica                    & X                & X                 & X                 & X                 &                \\ \hline
Definição do referencial teórico          & X                & X                &                 &                   &                   \\ \hline
Definição da metodologia                  &                  & X                 &                   &                  &                   \\ \hline
Definição da proposta                     &                  & X                 &                   &                   &                   \\ \hline
Revisão e refinamento                     &                  &                   &                   & X                 & X                 \\ \hline
